/*
  SimuPLC Lab 1.7.0-split-range-v10 - Arduino UNO R3 desde FBD
...
const uint8_t PIN_PWM1 = 9;
const uint8_t PIN_PWM2 = 10;
...
const uint8_t pwmOutputPins[SAFE_PWM_OUTPUTS] = { 9, 10 };
...
const float nodeP2[SAFE_NODES] = { 1023.0f, 1023.0f, 0.1f, 100.0f, 100.0f, 100.0f };
