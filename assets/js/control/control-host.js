(function(){
  ...
  let hmiControlState={inputs:{},outputs:{},states:{},simulationOn:false,receivedAt:0};
  ...
  function hmiControlStop(){hmiControlPost('stop',{});hmiControlState={inputs:{},outputs:{},states:{},simulationOn:false,receivedAt:Date.now()};}
  ...
  window.addEventListener('message',function(ev){
    ...
    if(ev.source===cw){
      ...
      if(msg.type==='SIMUPLC_CONTROL_HMI_STATE'){hmiControlState=Object.assign({inputs:{},outputs:{},states:{},simulationOn:false,receivedAt:Date.now()},msg.state||{});try{window.dispatchEvent(new CustomEvent('simuplc-control-hmi-state',{detail:hmiControlState}));}catch(_){}return;}
  ...
  window.SimuPLCControlHost = {
    ...
    hmi:{start:hmiControlStart,stop:hmiControlStop,setInput:function(tag,value){const o={};o[tag]=!!value;hmiControlSetInputs(o);},setInputs:hmiControlSetInputs,requestState:hmiControlRequest,getState:function(){return Object.assign({},hmiControlState,{inputs:Object.assign({},hmiControlState.inputs||{}),outputs:Object.assign({},hmiControlState.outputs||{}),states:Object.assign({},hmiControlState.states||{})});}}
  };
})();
