/*
  SimuPLC Lab 1.6.2-phase3-mcu-fix - Arduino UNO R3 desde FBD
...
const uint8_t pwmOutputPins[SAFE_PWM_OUTPUTS] = { 3 };
...
const float nodeP2[SAFE_NODES] = { 1023.0f, 1023.0f, 0.05f, 100.0f };
