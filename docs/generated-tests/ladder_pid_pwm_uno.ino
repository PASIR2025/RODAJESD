/*
  SimuPLC Lab 1.6.2-phase3-mcu-fix - Arduino UNO R3 desde LADDER PRO
...
void readInputs(){
  ...
  AI1 = mapFloat(AI1_raw,0.0f,1023.0f,0.0f,100.0f,true);
  AI2_raw = analogRead(PIN_AI2);
  AI2 = mapFloat(AI2_raw,0.0f,1023.0f,0.0f,100.0f,true);
}
