/*
  SimuPLC Lab 1.6.3-usb-analog - Arduino UNO R3 desde LADDER PRO
...
void readInputs(){
  ...
  physicalAnalogInputs[0] = mapFloat(AI1_raw,0.0f,1023.0f,0.0f,100.0f,true); AI1 = effectiveAnalogInput(0);
  AI2_raw = analogRead(PIN_AI2);
  physicalAnalogInputs[1] = mapFloat(AI2_raw,0.0f,1023.0f,0.0f,100.0f,true); AI2 = effectiveAnalogInput(1);
}
