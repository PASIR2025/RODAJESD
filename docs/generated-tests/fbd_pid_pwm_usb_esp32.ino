/*
  SimuPLC Lab 1.6.3-usb-analog - ESP32 desde FBD
...
const uint8_t pwmOutputPins[SAFE_PWM_OUTPUTS] = { 22 };
...
const float nodeP2[SAFE_NODES] = { 4095.0f, 4095.0f, 0.05f, 100.0f, 0.0f, 0.0f };
